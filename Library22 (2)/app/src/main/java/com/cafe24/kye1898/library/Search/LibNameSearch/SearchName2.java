...
public class SearchName2 extends AppCompatActivity {
    private String TAG = SearchName2.class.getSimpleName();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        park_name.setText(lib_name);
        search_button=(Button)findViewById(R.id.button_search);
        lv = (ListView) findViewById(R.id.list);
        try {
            lib_name = URLEncoder.encode(lib_name,"UTF-8");
        } catch (UnsupportedEncodingException e) {
            e.printStackTrace();
        }
        encodedName=lib_name;
        LargeList.clear();
        ...
        to_lib.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent to_lib= new Intent(SearchName2.this,SearchName1.class);
        ...
        to_book.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent to_book= new Intent(SearchName2.this,SearchBookMainActivity.class);
        ...
        search_button.setOnClickListener(new View.OnClickListener(){
            ...
            public void onClick(View v){
                ...
                if(library_name.isEmpty()){
                    Toast.makeText(SearchName2.this,"검색어를 입력해 주세요.",Toast.LENGTH_SHORT).show();
                }

                /*
                try {
                    encodedName = URLEncoder.encode(s_name,"UTF-8");
                } catch (UnsupportedEncodingException e) {
                    e.printStackTrace();
                }
                */
    ...
    private class GetContacts extends AsyncTask<Void, Void, Void> {
        ...
        protected void onPreExecute() {
            ...
            pDialog = new ProgressDialog(SearchName2.this);
        ...
        protected void onPostExecute(Void result) {
            ...
            lv.setOnItemClickListener(new AdapterView.OnItemClickListener(){
                public void onItemClick(AdapterView<?> parent, View view, int position, long id){
                    ...
                    Intent intent = new Intent(SearchName2.this, DetailActivity.class);
